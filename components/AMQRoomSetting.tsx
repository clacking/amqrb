...
const { HostRoom, HostSoloGame } = AMQEventsCommand;
...
const AMQRoomSetting = ({isOpen, onClose}: {isOpen: boolean, onClose: any}) => {
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            getContainer={() => document.querySelector('#AMQGameUI') as HTMLElement }
        >
            <ModalOverlay />
            <ModalContent>
            <ModalCloseButton />
